		...
		x:
			...
			Submissions:
				...
				Auth:
					...
					# PLAIN, LOGIN. The cleartext PLAIN and LOGIN mechanisms are only sent over a
					# TLS-protected connection; specify LOGIN for smarthosts that only offer AUTH
					# LOGIN (e.g. Azure Communication Services). Specify the strongest mechanism known
					# to be implemented by the server to prevent mechanism downgrade attacks.
					# (optional)
					Mechanisms:
						-
